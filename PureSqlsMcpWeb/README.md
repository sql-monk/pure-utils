...
- **[Приклади конфігурацій](CONFIGURATION_EXAMPLES.md)** - Детальні приклади налаштувань (порт, підключення, безпека)
- **[Інтеграція з GPT](GPT_INTEGRATION.md)** - OpenAPI schema та інструкції для GPT та інших AI чатів
