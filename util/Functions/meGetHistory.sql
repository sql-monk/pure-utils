/*
# Description
Отримує інформацію про активність поточного користувача з системних подій.
Функція повертає події, пов'язані з активністю користувача, який виконав вхід в систему.
...
# Usage
-- Отримати всю активність поточного користувача
SELECT * FROM util.myActivity(NULL);

-- Отримати активність з певного часу
SELECT * FROM util.myActivity('2025-09-16 00:00:00');
*/
CREATE FUNCTION util.meGetHistory(@startTime DATETIME = NULL)
RETURNS TABLE
AS
RETURN(
	SELECT
